...
bot = commands.Bot(command_prefix="!", help_command=None, intents=disnake.Intents.all(), test_guilds=[1067554815690952835])
...
async def on_member_join(member):
    role = disnake.utils.get(member.guild.roles, id=1132042292509810718)
    channel = utils.get(bot.get_all_channels(), id=1132340722541015050) 
